function [] = GenCBlocalDeclarationDZ(fileID,k,CB_settings)
% [] = GenCBlocalDeclarationDZ(fileID,k,CB_settings)
% Function GenCBlocalDeclarationDZ generates the local declaration for a CB timed automaton that is using Directional Zone selectivity
...
fprintf(fileID,'  int tselFW = %i;\n',CB_settings.CB{1,k}.tselFW);
fprintf(fileID,'  int tselBW = %i;\n',CB_settings.CB{1,k}.tselBW); 
...
%% The tsel Function
fprintf(fileID,'  void tsel(bool IsFWD){\n');
fprintf(fileID,'    if(IsFWD == true){\n      t = tselFW;\n    }\n');
fprintf(fileID,'    if(IsFWD == false){\n      t = tselBW;\n    }\n  }');
