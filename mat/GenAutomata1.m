function [] = GenAutomata1(A,Line,Bus,F_branch,F_bus,Irc,C,Iioc_values,Ith_values,Isc_values_Lines,Isc_values_Buses,fileID,CB_settings,Bus_connections)
...
% GenAutomata1 generates the Fault generator timed automaton, all the Circuit breaker timed automata
% and the necessary queries needed to verify selectivity.
% 
...
% 
% see also Reading_json_data1, GenUppaalCode1
